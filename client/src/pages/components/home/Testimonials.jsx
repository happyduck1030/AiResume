...
const Testimonial = () => {
  ...
  return (
    <>
    <div id='testimonials' className='flex flex-col items-center scroll-mt-10'>
      <div class="flex items-center gap-2 text-sm text-green-600 bg-blue-green/10 rounded-full px-6 py-1.5">
        <BookUserIcon className='size-4.5 stroke-green-600'>
        </BookUserIcon>
        <span>Testimonials</span>
      </div>
      <Title title="不要只是听从我们的一面之词" desription="多去听听使用过这个工具的人的评价，我们也一直期待更多的反馈。如果您有更多的建议或者意见，请不要吝啬。"></Title>
    </div>

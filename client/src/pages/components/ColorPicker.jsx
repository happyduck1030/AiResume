...
const ColorPicker = ({selectedColor,onChange}) => {
  ...
  return (
    <div className='relative'>
      <button className='flex items-center gap-1 tyext-sm text-purple-600 bg-gradient-to-r from-purple-50 to purple-100
       ring-purple-300 hover:ring transition-all px-3 py-2 rounded-xl' 
       onClick={()=>setIsOpen(!isOpen)}
       >
        <Palette size={16}></Palette><span className='max-sm:hidden'>Accent</span>
      </button>
      {isOpen && (
